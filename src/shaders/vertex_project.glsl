...
mouseTrail = smoothstep(0.5, 3.0, mouseTrail);

// Mouse Scale
transformed *= 1.0 + cubicOut(1.0 - mouseTrail) * uConfig.y;
...
transformed = rotate(transformed, vec3(0., 1., 1.), uConfig.y * (anim * 3.14 + uTime + toCenter * 0.4));
